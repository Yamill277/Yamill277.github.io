...
function SendMailSMTP(name, email, subject, message) {
    ...
    subject = "Contacto desde el potafolio GITHub. Asunto: " + subject;
    console.log("hola");
    Email.send("ramirezyamill2@gmail.com",
                "ramirezyamill2@gmail.com",
                subject,
                body,
                ...
                function done(message) {
                                            ...
                                            $('#myModal').modal("show");
                                            $('#PmodalAttention').html("Su Información fue enviada correctamente a Yamilll Ramirez, Prontamente tendras noticias");
                                            ClearControls();
                                        }
    );
};
